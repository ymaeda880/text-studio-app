...
PRESETS: Dict[str, Dict] = {
    ...
    "論文：左余白広め・外ラベル": {
        ...
        "m_k_outerframe_style": "なし",
        "m_k_legend_location": "外-上", "m_k_legend_orientation": "横(h)", "m_k_legend_font_size": 14,
    },
    "プレゼン：文字大きめ・凡例は下外": {
        ...
        "m_k_show_grid": True,
        "m_k_legend_location": "外-下", "m_k_legend_orientation": "横(h)", "m_k_legend_font_size": 16,
        "m_k_title_size": 26, "m_k_title_align": "中央",
    },
    "記事/Web：フラット（枠なし・薄グリッド）": {
        "m_k_show_grid": False,
        "m_k_frame_style": "なし", "m_k_outerframe_style": "なし",
        "m_k_ticks_y": "(なし)", "m_k_ticklen_y": 0,
        "m_k_ticks_x": "outside", "m_k_ticklen_x": 4, "m_k_ticklabelpos_x": "外-下",
        "m_k_legend_location": "内-右上", "m_k_legend_orientation": "縦(v)",
        "m_k_legend_bg": "rgba(255,255,255,0.6)", "m_k_legend_borderwidth": 0,
        "m_k_palette_name": "Playful", "m_k_color_alpha": 0.8,
    },
    "学会投稿：細線・角丸外枠": {
        "m_k_show_grid": True,
        "m_k_frame_style": "四角", "m_k_frame_dash": "点線",
        "m_k_outerframe_style": "角丸", "m_k_outerframe_dash": "実線", "m_k_outer_radius_px": 16,
        "m_k_legend_location": "外-右", "m_k_legend_orientation": "縦(v)", "m_k_legend_font_size": 12,
        "m_k_axis_title_size": 14, "m_k_tick_font_size": 12,
        "m_k_palette_name": "Corporate", "m_k_color_alpha": 0.9,
        "m_k_x_title_standoff": 14, "m_k_y_title_standoff": 14,
    },
}
...
y_cols = st.multiselect(
    ...
    default=default_y_cols  # 初期値：全部選択
)
